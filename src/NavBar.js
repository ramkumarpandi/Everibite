...
<img src={login} alt="fbIcon" className="float-left mr-4"/>
            ...
            type="submit"
            className="px-5 mb-4 loginBtn font18 everibiteViga">
            LOGIN
            </Button></Link>
            <Button
            block   bsSize="large"
            ...
            <h4 className="registerNow everibiteRobotoRegular font14">Register Now ! and Create an Account</h4>
            </Modal.Title>
		 ...
		 <FormControl
            ...
            disabled={!this.validateForm()}
            type="submit"
            className="px-5 mb-4 loginBtn regBtn">
            Register
            </Button></Link>
            </form>
